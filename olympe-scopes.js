 ...
 * build scopes-2026-09-21-SCOPES8
 *
...
(function (global) {
  ...
  var BUILD = 'scopes-2026-09-21-SCOPES8';
  ...
  var SCOPES = [
    ...
    'olympe_annonce_v1',
    /* Séances de la carte « Bouger & respirer » : une entrée par
       séance terminée, plus l'objectif hebdomadaire de chaque agent. */
    'olympe_forme_v1'
  ];
  ...
  var CUMULATIVE = [
    ...
    'olympe_annonce_v1',
    /* Cumulatif : deux agents qui terminent une séance en même temps
       depuis deux postes ne doivent pas s'effacer l'un l'autre. */
    'olympe_forme_v1'
  ];
  ...
  var LIBELLES = {
    ...
    olympe_forme_v1: 'Bouger & respirer'
  };
...
,
    ...
    /* ── Bouger & respirer ──────────────────────────────────────────────
         _meta              version du format
         f:<agent>|<jour>|<séance>|<n>   une séance terminée
         o:<agent>          l'objectif hebdomadaire de cet agent
         x:<clé>            une suppression publiée

       Au grain de la séance faite : sans cela, deux agents qui terminent
       dans la même minute depuis deux postes produiraient une seule
       ligne, et le second effacerait le premier. */
    olympe_forme_v1: {
      split: function (o) {
        o = (o && typeof o === 'object') ? o : {};
        var out = { _meta: { v: o.v || 1 } };
        var fa = (o.faits && typeof o.faits === 'object') ? o.faits : {};
        Object.keys(fa).forEach(function (k) { if (k) out['f:' + k] = fa[k]; });
        var ob = (o.obj && typeof o.obj === 'object') ? o.obj : {};
        Object.keys(ob).forEach(function (a) { if (a) out['o:' + a] = ob[a]; });
        var sup = (o.supprimes && typeof o.supprimes === 'object') ? o.supprimes : {};
        Object.keys(sup).forEach(function (k) { if (k) out['x:' + k] = sup[k] || 1; });
        return out;
      },
      join: function (e) {
        var supprimes = {}, faits = {}, obj = {};
        ...
        Object.keys(e).forEach(function (k) {
          if (k.indexOf('f:') === 0) {
            var c = k.slice(2);
            if (!supprimes[c] && e[k]) faits[c] = e[k];
          } else if (k.indexOf('o:') === 0) {
            if (e[k]) obj[k.slice(2)] = e[k];
          }
        });
        var meta = e._meta || {};
        return { v: meta.v || 1, faits: faits, obj: obj, supprimes: supprimes };
      }
    },
