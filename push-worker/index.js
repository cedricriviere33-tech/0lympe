...
function start() {
  ...
  async function onMessage(m) {
    ...
    // On notifie TOUS les abonnés. C'est le service worker qui n'affichera la
    // notif que si l'app n'est pas au premier plan (sinon la bulle in-app suffit).
    const res = await sb.from('push_subscriptions').select('*');
