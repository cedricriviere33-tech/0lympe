...
(function (global) {
  ...
  try { console.info('[olympe-store] presence + gate + suppression volontaire \u2013 build 2026-09-06'); } catch (e) {}
  ...
  function _askGeo() {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      function () { /* refus ou erreur : position laissee a null, le poste reste liste */ },
  ...
  function startPresence() {
    ...
    _askGeo(); _beat();
    _presenceTimer = setInterval(function () { _askGeo(); _beat(); }, 30000);
