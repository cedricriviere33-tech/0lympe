...
(function (global) {
  ...
  function diff(scope) {
    ...
    if (CUMULATIVE.indexOf(scope) < 0) {
      ...
      // On conserve les cles connues dans l'ombre : elles restent dans le cloud.
      Object.keys(prev).forEach(function (id) {
        if (!next.hasOwnProperty(id)) next[id] = prev[id];
      });
    }
  ...
  try { console.info('[olympe-store] presence + gate + fix cumulatif \u2013 build 2026-09-04b'); } catch (e) {}
